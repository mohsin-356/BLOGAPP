...
const Write = () => {
  ...
  if (isLoaded && !isSignedIn) return <div>Please sign in to write a post.</div>;
  return (
    <div className='h-[calc(100vh-64px)] md:h-[calc(100vh-80px)] flex flex-col gap-6'>
      ...
      <form className="flex flex-col gap-6 flex-1 mb-6">
        ...
        <textarea name="desc" placeholder='A short Description' className="p-4 rounded-xl bg-white shadow-md"></textarea>
